...
class CentralCorridor(Scene):
    def enter(self):
        ...
        if action == "shoot!":
            ...
            print "Lbhe zbgure vf fb sng, jura fur fvgf nebhaq gur ubhfr, fur fvgf nebhaq gur ubhf."
...
class LaserWeaponArmory(Scene):
    def enter(self):
        ...
        print "for more Gothons that might be hiding. It's dead quiet, too quited."
        print "You stand up and run to the far side of the room and find the"
        print "neutron bomb in its container. There's a keypad lock on the box"
        print "and you need the code to get the bomd out. If you get the code"
...
class TheBridge(Scene):
    def enter(self):
        print "You burst onto the Brigde with the neutron destruct bomb"
        ...
        if action == "throw the bomb":
            print "In apanic you throw the bomb at the group of Gothons"
            print "and make a leap for the door. Right as you drop it a"
            print "Gothon shoots you right in the back killing you."
            print "As you die you see anothe Gothon frantically try to disarm"
            print "the bomb. You die knowing the will probally blow up when"
            print "it goes off."
            return 'death'
            ...
            print "and the blast the lock so the Gothons can't get out."
